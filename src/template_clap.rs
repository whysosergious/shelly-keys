...
struct Cli {
    ...
    //? the macro handles Option for optional args e.g. "Option<String>"
    /// Optional name to operate on
    #[arg(default_value_t)]
    optional_name: String,

    //? action "Count" also allows multiple values. default: "SetTrue" (false/0)
